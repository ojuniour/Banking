...
namespace Bank
{
    ...
    public partial class bank_db : DbContext
    {
        public bank_db()
            : base("name=bank_db")
        {
        ...
        public virtual IQueryable<logger1_Result> logger1(Nullable<int> test)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<logger1_Result>("[bank_db].[logger1](@test)", testParameter);
        }
